...
@Controller
@RequestMapping(HomePageController.Home_Base_URI)

public class HomePageController {
	public static final String Home_Base_URI="/home";	
	...
	private void loadHomePage(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException
	{
		request.getRequestDispatcher("/WEB-INF/views/view/home.jsp").forward(request, response);
	}
